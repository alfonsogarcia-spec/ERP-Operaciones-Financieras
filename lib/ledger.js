...
// va a cobrar por otro medio (ej. manual, via Retenciones) en vez de dejar
...
// nada -- el historico queda intacto, solo deja de ser cobrable via el ledger.
...
module.exports = {
  ...
  listarBacklog, congelarBacklog, reprogramarCargos,
};
