  ...
  },
  {
    ...
    form_schema: {
      secciones: [
        ...
        { titulo: 'Condiciones comerciales', campos: [
          { key: 'tasa', label: 'Tasa Pactada con el Cliente', tipo: 'text', required: true, hint: 'Ej. 2.5% + IVA' },
        ]},
  ...
  },
  {
    ...
    form_schema: {
      secciones: [
        ...
        { titulo: 'Condiciones comerciales', campos: [
          { key: 'tasa', label: 'Tasa Pactada', tipo: 'text', required: true },
        ]},
        { titulo: 'Modalidad de activación', campos: [
    ...
    form_schema: {
      secciones: [
        ...
        { titulo: 'Afiliación principal', campos: [
          ...
          { key: 'tasa_actual', label: 'Tasa actual', tipo: 'text', required: true },
        ...
        { titulo: 'Cambio solicitado', campos: [
          ...
          { key: 'tasa_nueva', label: 'Tasa pactada nueva', tipo: 'text' },
